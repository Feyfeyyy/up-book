...
CREATE_BOOKS_TABLE = "CREATE TABLE IF NOT EXISTS books (id SERIAL PRIMARY KEY, title TEXT, isbn TEXT, account_id INTEGER, created_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (account_id) REFERENCES accounts(id) ON DELETE CASCADE);"
...
INSERT_BOOKS = (
    "INSERT INTO books (title, isbn, account_id) VALUES (%s, %s, %s) RETURNING id;"
)
